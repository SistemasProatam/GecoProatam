...
$sql_cliente = "SELECT razon_social FROM proveedores WHERE id = ?";
$stmt_cliente = $conn->prepare($sql_cliente);
$stmt_cliente->bind_param("i", $proveedor_id);
$stmt_cliente->execute();
$proveedor = $stmt_cliente->get_result()->fetch_assoc();
                ...
                ?>
                  <tr>
                    ...
                    <td class="text-center">
                      <button class="btn btn-sm btn-outline-primary" onclick="verDetalle(<?= $eval['id'] ?>)"><i class="bi bi-eye"></i> Detalle</button>
                    </td>
                  </tr>
                <?php endwhile; ?>
              <?php else: ?>
      ...
      const html = `
        <div class="p-2">
          ...
          <div class="bg-light p-3 rounded text-center">
            ...
            <div class="h2 mb-0 text-primary fw-bold">${e.total_puntuacion} pts</div>
          </div>
