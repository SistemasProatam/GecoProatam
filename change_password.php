...
// Si no tiene el flag de cambio de contraseña temporal, no tiene nada que hacer aquí
if (!isset($_SESSION['change_pass']) || $_SESSION['change_pass'] !== true) {
        ...
        <div class="row g-0 auth-container">
            ...
            <div class="col-lg-5 col-xl-4 auth-panel">
                <div class="auth-form-wrapper">
                    ...
                    <a href="logout.php" class="back-link" style="display: inline-flex; align-items: center; gap: 8px; margin-top: 3vh; font-size: 0.8rem; font-weight: 600; color: var(--gray-400); text-decoration: none;">
        ...
        document.getElementById('changePassForm').addEventListener('submit', async function(e) {
            ...
            try {
                ...
                if (result.status === 'success') {
                    UI.toast.success(result.message || 'Contraseña actualizada correctamente.', 3000);
